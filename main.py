...
def text(mess):
    ...
    if mode == 1:
        ...
        elif mess.text.lower() == 'фотографии':
            bot.send_photo(mess.chat.id, 'https://avatars.mds.yandex.net/get-altay/932730/2a00000184b4666abef281ee34bc6700e2ce/XXL_height')
            bot.send_message(mess.chat.id, 'Фотографии разлагаются от 3 месяцев до 1 года')
